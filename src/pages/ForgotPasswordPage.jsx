            ...
            <div className={styles.forgotPasswordContent}>
                <div className={styles.forgotPasswordCard}>
                    <div className={styles.forgotPasswordLogo}>
                        <div className={styles.forgotPasswordLogoIcon}>
                    ...
                    {!isSubmitted ? (
                        <>
                            <h2 className={styles.forgotPasswordTitle}>Restablecer Contraseña</h2>
                        ...
                        <div className={styles.successMessage}>
                            ...
                            <p className={styles.forgotPasswordText}>
                                No recibiste el correo? <a href="#" onClick={() => setIsSubmitted(false)}>Reenviar</a>
                            </p>
                            <p className={styles.forgotPasswordText}>
                                <Link to="/login">Volver al inicio de sesión</Link>
                            </p>
